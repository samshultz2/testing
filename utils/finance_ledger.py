...
_ADDED_COLUMNS = {
    ...
    'students': {
        ...
        'waec_reg_number': 'VARCHAR(30)', 'serial_number': 'VARCHAR(30)', 'waec_epin': 'VARCHAR(30)',
...
def ensure_tables(bind=None):
    ...
    from models import (db, FinanceTransaction, AdditionalCharge, InstallmentPlan,
                        ...
                        AssetLog, AssetStatusCount, AssetUnit, AssetMaintenance,
    ...
    from models import (TermAssessmentSetting, StaffInvite, StaffSignup, GraduateAudit,
                        GraduateDocument, AlumniProfile, DocumentRequest, DocTemplatePref,
                        DocumentVerification, StudentPhoto,
                        WAECCertTemplate, WAECCertPreset, WAECCertIssue)
    tables = [FinanceTransaction.__table__, AdditionalCharge.__table__,
              ...
              AssetUnit.__table__, AssetMaintenance.__table__,
              AssetAudit.__table__, AssetAuditItem.__table__, UserSession.__table__,
              ...
              GraduateDocument.__table__, AlumniProfile.__table__, DocumentRequest.__table__,
              DocTemplatePref.__table__, DocumentVerification.__table__,
              StudentPhoto.__table__, WAECCertTemplate.__table__,
              WAECCertPreset.__table__, WAECCertIssue.__table__]
