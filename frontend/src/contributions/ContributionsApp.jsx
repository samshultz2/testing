...
function Bar({ pct, color = '#28a745', height = 8 }) {
  return (
    ...
    <>
      ...
      <div className="card mb-3"><div className="card-body">
        ...
        <div style={{ background: '#e9ecef', borderRadius: 10, height: 24, overflow: 'hidden', position: 'relative' }}>
          <div style={{ background: 'linear-gradient(90deg, #1a5f4a, #28a745)', height: '100%', width: `${s.collection_rate}%` }} />
          ...
          {d.arms_summary.map((a) => (
            <div className="arm-progress-row" key={a.name}>
              ...
              <div className="arm-bar-container">
                <div className="arm-bar" style={{ width: `${a.percentage}%`, background: a.percentage >= 75 ? '#28a745' : a.percentage >= 50 ? '#ffc107' : '#dc3545' }} />
              </div>
    ...
    <>
      ...
      <div className="card mb-3"><div className="card-body">
        ...
        <div style={{ background: '#e9ecef', borderRadius: 10, height: 24, overflow: 'hidden', display: 'flex' }}>
          <div style={{ background: '#dc3545', height: '100%', width: `${d.expense_rate}%` }} />
          <div style={{ background: '#28a745', height: '100%', width: `${100 - d.expense_rate}%` }} />
        </div>
      </div></div>
          ...
          <div className="card mb-3" key={a.name}>
            ...
            <div className="card-body">
              <div className="info-grid mb-3">
                ...
                <div className="info-row"><span>Received:</span><strong style={{ color: '#28a745' }}>{money(a.total_paid)}</strong></div>
              ...
              <div style={{ background: '#e9ecef', borderRadius: 8, height: 16, overflow: 'hidden', marginBottom: '1rem' }}>
                <div style={{ background: 'linear-gradient(90deg, #1a5f4a, #28a745)', height: '100%', width: `${pct}%` }} />
              </div>
              <table className="data-table">
    ...
    <>
      ...
      <div className="card mb-3"><div className="card-body">
        ...
        <div style={{ background: '#e9ecef', borderRadius: 10, height: 24, overflow: 'hidden' }}>
          <div style={{ background: pct >= 100 ? '#28a745' : pct >= 50 ? '#ffc107' : '#dc3545', height: '100%', width: `${Math.min(100, pct)}%` }} />
        </div>
      </div></div>
      <div className="row">
