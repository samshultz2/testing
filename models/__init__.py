...
from .models_university import University, Course, UniversityCourse, StudentScholarship, effective_cutoff
...
__all__ = [
    ...
    'University', 'Course', 'UniversityCourse', 'StudentScholarship', 'effective_cutoff',
